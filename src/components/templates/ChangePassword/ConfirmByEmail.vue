<template>
  <div @submit="onSubmit" class="row q-mx-auto" style="max-width: 500px;">
    <p class="txt-verification col-12 q-mt-xl">Change Password</p>
    <p class="txt-info col-12">Input your new password</p>
...
export default {
  name: 'TemplateChangePasswordConfirmByEmail',
  ...
  methods: {
    onSubmit() {
      ...
      this.$store
        .dispatch('authentication/changePassword', { token, password, rePassword })
